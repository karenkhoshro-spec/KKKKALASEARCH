...
check('province required', ks_validate_order_payload($noProvince) === 'province_required');
$noCity = $valid;
...
check('invalid postal code', ks_validate_order_payload($badPostal) === 'invalid_postal_code');
$badEmail = $valid;
