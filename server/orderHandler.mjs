...
function adminSecret() {
  return process.env.ADMIN_SESSION_SECRET || "kala-search-local-secret";
}

function adminUser() {
  return process.env.ADMIN_USERNAME || "karen";
}

function adminPass() {
  return process.env.ADMIN_PASSWORD || "mkhoshrou1381";
}
