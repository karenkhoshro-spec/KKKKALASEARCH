...
import { LogOut, PhoneCall, Mail, User, PackageSearch, CheckCircle2, ArrowLeft } from "lucide-react";
...
export default function AccountPage() {
  ...
  const handleSendOtp = (e: React.FormEvent) => {
    ...
    if (authMethod === "phone") {
      ...
      showToast(t("notifications.otpSent") || "کد تأیید برای ادامه آماده شد", "info");
    } else {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-5 sm:px-6">
      ...
      >
        ...
        >
          <ArrowLeft size={16} style={{ color: "var(--accent-1)" }} />
      ...
      {!isLoggedIn ? (
        <div className="glass rounded-3xl p-6 sm:p-8" style={{ border: "1px solid var(--border-soft)" }}>
        ...
        <div className="flex flex-col gap-5">
          <div className="glass-strong flex items-center gap-4 rounded-3xl p-5" style={{ border: "1px solid var(--border-soft)" }}>
          ...
          <form onSubmit={handleSaveName} className="glass flex flex-col gap-3 rounded-3xl p-5" style={{ border: "1px solid var(--border-soft)" }}>
            <label className="text-xs font-semibold" style={{ color: "var(--text-muted)" }}>
              {t("account.nameLabel")}
            </label>
            <input
          ...
          <div className="glass rounded-3xl p-5" style={{ border: "1px solid var(--border-soft)" }}>
