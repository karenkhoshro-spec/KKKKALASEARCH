      ...
      <div className="grid gap-6 md:grid-cols-2 md:gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <div className="product-media relative mx-auto flex h-[150px] w-full max-w-xs items-center justify-center overflow-hidden rounded-2xl p-2 sm:h-[170px] md:h-[190px] md:max-w-sm">
              {activeImage ? (
                <img
                  key={activeImage}
                  src={activeImage}
