  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-5 sm:px-6">
      ...
      {items.length === 0 ? (
        ...
        <>
          {/* Section 1 — order selection: the lines the customer is about to submit */}
          <h2 className="mb-3 flex items-center gap-2 text-sm font-black" style={{ color: "var(--text-primary)" }}>
            ...
            <span>{t("cart.orderSelection")}</span>
          </h2>
          <div className="flex flex-col gap-2.5">
            {items.map((item) => {
              ...
              const colorHex = item.variation?.colorHex;
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1 text-[11px] leading-5 sm:text-xs">
                        ...
                        {colorHex ? (
                          <span
                            ...
                            style={{
                              background: colorHex,
                              borderColor:
                                colorHex.toLowerCase() === "#ffffff" || colorHex.toLowerCase() === "#f8fafc"
                                  ? "var(--border-strong)"
                                  : colorHex,
                            }}
                          />
                    ...
                    {variationName && variationName !== color && variationName !== item.name ? (
