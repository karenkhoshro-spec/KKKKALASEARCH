    ...
    <>
      ...
      >
        <div className="flex flex-col items-center px-4 pt-5 pb-3">
          ...
          <p className="ks-menu-tagline w-full text-center">
            {t("menu.tagline")}
          </p>
          <div className="ks-menu-family mt-4 w-full">
            ...
            />
            <p className="ks-menu-family-caption">{t("menu.familySubCaption")}</p>
          </div>
        </div>

        {/* Uniform Crystal Menu Cards — every item shares one purple crystal style */}
        <nav className="mt-4 flex flex-col gap-2.5 px-3.5">
          {/* Home Card */}
          <Link
            to="/"
            onClick={onClose}
            className="ks-menu-purple-btn flex items-center justify-between rounded-2xl px-4 py-3 text-sm font-bold transition-all duration-200 hover:scale-[1.01] active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className="ks-menu-purple-btn flex items-center justify-between rounded-2xl px-4 py-3 text-sm font-bold transition-all duration-200 hover:scale-[1.01] active:scale-95 cursor-pointer text-start"
          >
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl" style={{ background: "var(--chip-bg)", color: "var(--accent-1)" }}>
                <Info size={17} />
          ...
          <button
            ...
            className="ks-menu-purple-btn flex items-center justify-between rounded-2xl px-4 py-3 text-sm font-bold text-start"
          >
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl" style={{ background: "var(--chip-bg)", color: "var(--accent-3)" }}>
                <Phone size={17} />
      ...
      <ContactOverlay open={showContactOverlay} onClose={() => setShowContactOverlay(false)} />
    </>
  );
}
