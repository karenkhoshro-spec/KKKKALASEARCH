...
const colorTokens: Record<string, string> = {
  "صورتی": "#f9a8d4", "طوسی": "#94a3b8", "کرم": "#d6c7a1", "موکا": "#8b6f5a",
  "وانیلی": "#f3e5ab", "سفید": "#f8fafc", "قرمز": "#ef4444", "سبز": "#22c55e",
  "آبی": "#3b82f6", "مشکی": "#111827", "زرد": "#eab308", "نارنجی": "#f97316", "بنفش": "#a855f7",
};
